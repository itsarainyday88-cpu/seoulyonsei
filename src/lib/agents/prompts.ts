...
- **이미지 유동성 (최소 2장 이상 필수)**: 무지성으로 3장을 채우지 말고 글의 호흡에 맞춰 유동적으로 배치하라.
- **필수 배치**: 서론(사고의 시작)과 결론(시설/안내)에는 문맥에 맞는 사진을 반드시 각 1장씩(도합 2장) 배치하라.
- **본문 가변 배치**: 본문 중간(Body) 섹션은 텍스트 단락이 길어져 시각적 환기가 필요할 때만 선택적으로 1~2장 추가 생성하라. 불필요하면 [텍스트 요약 박스]로 대체하라.
...
4. [Philosophy]: 교육 철학 및 사고방식 서술. (세련된 한글 소제목 필수)
   - [이미지 전략: 문맥 전환용 선택적 사용]
5. [Evidence]: 관리 방식 및 학생 변화 사례 공유.
   - [이미지 전략: 사례 증명용 선택적 사용]
...
4. [Why Now]: 현 시점의 결정이 중요한 이유. (강렬한 소제목 사용)
   - [이미지 전략: 긴박함 시각화용 선택적 사용]
5. [Credibility]: 전문성 기반의 최종 신뢰 보강.
   - [이미지 전략: 전문성 뒷받침용 선택적 사용]
